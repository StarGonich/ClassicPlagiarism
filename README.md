...
- Установка Joern 4.0.xxx версии, к примеру стабильно работает версия 4.0.426 [(скачать)](https://github.com/joernio/joern/releases/download/v4.0.426/joern-cli.zip). Добавьте папку .../joern-cli/bin в переменные пути PATH
- PyPy 3.11 [(скачать)](https://downloads.python.org/pypy/pypy3.11-v7.3.23-win64.zip), также добавьте в PATH
...
```
pypy3 files_to_graph.py submits-911-2_OK_JOERN
```
